...
async function main() {
  ...
  if (!password) {
    console.log('\n============================================================');
    console.log('SUPPORT CENTER MODULE DATABASE MIGRATION SCRIPT');
    console.log('============================================================');
    ...
    console.log(`\n👉 File: ${path.resolve(__dirname, '../supabase/support_center_schema.sql')}`);
    console.log('\nOPTION B (Direct CLI execution):');
    console.log('Run this script again providing your Supabase database password:');
    console.log('  node scripts/apply-support-db.js <your_database_password>');
    console.log('============================================================\n');
    return;
  }
  ...
  const schemaSql = fs.readFileSync(path.join(__dirname, '../supabase/support_center_schema.sql'), 'utf8');
  ...
  try {
    ...
    console.log('Successfully connected! Applying Support Center SQL migrations...');
    await client.query(schemaSql);
    console.log('Support Center SQL migrations applied successfully!');
  } catch (err) {
