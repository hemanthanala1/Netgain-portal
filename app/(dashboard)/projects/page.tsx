  ...
  const handleUploadReport = async (projectId: string, clientName: string) => {
    ...
    try {
      ...
      if (reportDestination === 'google-drive') {
        // Upload directly to project's Google Drive workspace
        const formData = new FormData()
      ...
      toast({
        ...
        description: `${reportTitle} (${reportType})`
      })
                  ...
                  <Card className="bg-card border-border p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Button
                        ...
                        onClick={() => handleOpenImportDriveDialog(detailProject.id)}
                      >
